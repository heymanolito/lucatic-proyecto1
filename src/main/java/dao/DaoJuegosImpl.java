...
<<<<<<< HEAD
	...
	/**
	 * Da de alta el juego que el usuario quiera, generando un cÛdigo aleatorio y preguntando los
	 * atributos del juego.
	 * @param Juego juego
	 *
	 */	
...
<<<<<<< HEAD
		for (Integer juego : lista.keySet()) {
	        ...
	        System.out.println("Fecha de publicaciÛn: " + lista.get(juego).getFechaPubliacion());
	        System.out.println("Plataforma: " + lista.get(juego).getPlataforma());
	        System.out.println("GÈnero: " + lista.get(juego).getGenero());
